    ...
    for value in data:
        ...
        for value2 in installedPlugin:
            if value['Name']== value2['Name']:
                Status="Installed"
        y = {"Name": value['Name'], "AssemblyVersion": value['AssemblyVersion'], "LastUpdate": str(datetime_obj), "Status": Status}
...
def modiflyWithName(dir:str,key:str,name:str,setKey:str,set:str):
    found = False
    with open(dir, 'r') as file:
        file_data = json.load(file)
    for idx, dictionary in enumerate(file_data):
